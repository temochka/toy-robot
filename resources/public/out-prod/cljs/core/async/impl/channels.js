...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14044 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14044 = (function (val,box,meta14045){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14044.cljs$lang$type = true;
cljs.core.async.impl.channels.t14044.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14044";
cljs.core.async.impl.channels.t14044.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write(writer__4111__auto__,"cljs.core.async.impl.channels/t14044");
});
cljs.core.async.impl.channels.t14044.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14044.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14046){var self__ = this;
var _14046__$1 = this;return self__.meta14045;
});
cljs.core.async.impl.channels.t14044.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14046,meta14045__$1){var self__ = this;
var _14046__$1 = this;return (new cljs.core.async.impl.channels.t14044(self__.val,self__.box,meta14045__$1));
});
cljs.core.async.impl.channels.__GT_t14044 = (function __GT_t14044(val__$1,box__$1,meta14045){return (new cljs.core.async.impl.channels.t14044(val__$1,box__$1,meta14045));
});
}
return (new cljs.core.async.impl.channels.t14044(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14047 = self__.takes.pop();if((taker_14047 == null))
{} else
{if(taker_14047.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_14048 = taker_14047.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_14048,taker_14047,this$__$1){
return (function (){return (take_cb_14048.cljs$core$IFn$_invoke$arity$1 ? take_cb_14048.cljs$core$IFn$_invoke$arity$1(null) : take_cb_14048.call(null,null));
});})(take_cb_14048,taker_14047,this$__$1))
);
} else
{}
{
