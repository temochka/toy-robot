...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13945 = (0);while(true){
if((i_13945 < arr.length))
{(arr[i_13945] = null);
{
...
{var i_13952 = (self__.level + (1));while(true){
if((i_13952 <= (new_level + (1))))
{(update[i_13952] = self__.header);
{
var G__13953 = (i_13952 + (1));
i_13952 = G__13953;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13954 = (0);while(true){
if((i_13954 <= self__.level))
{var links_13955 = (update[i_13954]).forward;if(((links_13955[i_13954]) === x__$1))
{(links_13955[i_13954] = (x__$1.forward[i_13954]));
{
